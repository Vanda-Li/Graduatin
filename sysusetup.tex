...
\sysusetup{
  title                = {基于RAG技术的智能问答系统设计与实现},
  title*               = {Design and Implementation of an Intelligent Question-Answering System Based on RAG Technology},
  author               = {黎万达},
  author*              = {Li Wanda},
  speciality           = {计算机科学与技术},
...
\makeatletter
% 浮动专页默认会把单个表图垂直居中；这里改为贴近页首，减少大块留白。
\setlength{\@fptop}{0pt}
\makeatother
